...
### 3.5. Resolve programme links — not optional
...
to re-run (already-linked pieces are skipped), non-fatal per piece (an
unresolved one keeps the search fallback), and plan-neutral.
